      ...
      <section className="collection" id="collection">
        ...
        <div className="product-grid">
          {[
            ...
            { number: "08", name: "OUTFIT", images: ["outfit-smartwatch.webp", "outfit-campaign.png"], description: "A refined, colour-changing dial created to complement the outfit of the day — from quiet business tailoring to relaxed weekends and elegant evenings.", features: ["Multiple coordinated colour palettes", "One-tap style changes", "Analog time with central seconds", "Date display", "Roman numeral accents", "Designed to complement different outfits and occasions"], provisional: true },
