...
export default function CookiePolicy() {
  return <main className="policy-page"><nav className="policy-nav"><a className="wordmark" href="/"><img className="brand-logo" src="/demand-group-logo.jpg" alt="Demand Group Italy" width="1280" height="368" /></a><a href="/">Back to studio</a></nav><article className="policy-document">
    ...
    <div className="feature-spec"><h4>Technical cookie</h4><dl><div><dt>Name</dt><dd>dg_cookie_consent</dd></div><div><dt>Purpose</dt><dd>Remembers your acknowledgement of the current necessary-only settings.</dd></div><div><dt>Provider</dt><dd>Demand Group (first party)</dd></div><div><dt>Duration</dt><dd>Up to 183 days</dd></div><div><dt>Legal basis</dt><dd>Necessary to store the user&apos;s privacy preference.</dd></div></dl></div>
